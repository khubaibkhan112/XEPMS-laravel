...
class ImportBookingComReservations extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'channel:import-booking-com
     ...
     * @var string
     */
    protected $description = 'Import reservations from Booking.com channel connections';
    ...
    public function handle(ReservationImportService $importService): int
    {
        ...
        if ($connections->isEmpty()) {
            $this->error('No active Booking.com connections found.');
    ...
    {
        $query = ChannelConnection::where('channel', 'booking_com')
